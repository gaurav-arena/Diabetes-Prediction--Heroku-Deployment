...
The dataset used in the model is PIMA Indian Diabetes Dataset and is from the National Institute of Diabetes and Digestive and Kidney Diseases. (Dataset Source-https://www.kaggle.com/uciml/pima-indians-diabetes-database)
